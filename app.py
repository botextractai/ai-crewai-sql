...
st.title("Natural language SQL queries")

st.markdown("""
This app lets you interact with your database using natural language.
Simply type your data question or request (for example, "Show me the top 5 products by total revenue for June 2025"), and this multi-agent system will:
...
This app is for business users, analysts, and anyone who wants to query data without writing SQL by hand!
""")
...
if st.button("Refresh Schema"):
    load_schema.clear()  # Clear the cache so next call reloads from database
...
user_prompt = st.text_input("Enter your request (e.g., 'Show me the top 5 products by total revenue for June 2025'):")
